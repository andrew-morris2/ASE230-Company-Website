        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto navbar-center" id="navbar-navlist">
                    ...
                    <li class="nav-item"><a href="create.php" class="nav-link active">Add Award</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="section" id="edit-award">
        <div class="container">
            <div class="form-container">
                <h2 class="form-title fw-bold">Add Award</h2>
                <form action="" method="POST"> <!-- Action for form submission -->
                    <input type="hidden" name="action" value="add">
                    <div class="mb-3">
                        <label for="awardName" class="form-label">Award Name</label>
                        <input type="text" class="form-control" id="awardName" name="awardName" value="" required />
                    </div>
                    <div class="mb-3">
                        <label for="awardYear" class="form-label">Year Awarded</label>
                        <input type="number" class="form-control" id="awardYear" name="awardYear" value="" required />
                    </div>
                    <div class="mb-3">
                        <label for="awardDescription" class="form-label">Award Description</label>
                        <textarea class="form-control" id="awardDescription" name="awardDescription" rows="4" style="height: 100px;" required></textarea>
                    </div>
                    <input type="hidden" name="awardId" value="<?php echo htmlspecialchars($awardId); ?>" /> <!-- Hidden field for ID -->
                    <button type="submit" class="btn btn-primary btn-custom">Add Award</button>
                </form>
            </div>
        </div>
    </section>

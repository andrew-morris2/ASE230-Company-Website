...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto navbar-center" id="navbar-navlist">
                    ...
                    <li class="nav-item"><a href="index.php" class="nav-link">Awards</a></li>
    ...
    <section class="section" id="edit-award">
        <div class="container">
            <div class="form-container">
                <h2 class="form-title fw-bold">Delete Award</h2>
                <form action="" method="POST"> <!-- Action for form submission -->
                <input type="hidden" name="action" value="delete">
                    <div class="mb-3">
                        <label for="awardName" class="form-label">Award Name</label>
                        <input type="text" class="form-control" id="awardName" name="awardName" value="<?php echo htmlspecialchars($award_name); ?>" required readonly />
                    </div>
                    <div class="mb-3">
                        <label for="awardYear" class="form-label">Year Awarded</label>
                        <input type="number" class="form-control" id="awardYear" name="awardYear" value="<?php echo htmlspecialchars($csv_year); ?>" required readonly />
                    </div>
                    <div class="mb-3">
                        <label for="awardDescription" class="form-label">Award Description</label>
                        <textarea class="form-control" id="awardDescription" name="awardDescription" rows="4" style="height: 100px;" required readonly><?php echo htmlspecialchars($description); ?></textarea>
                    </div>
                    <input type="hidden" name="awardId" value="<?php echo htmlspecialchars($awardId); ?>" /> <!-- Hidden field for ID -->
                    <button type="submit" class="btn btn-danger btn-custom" id="deleteForm" onclick="confirmDelete()">Delete</button> <!-- Button calls confirmDelete() -->
                </form>
            </div>
        </div>
    </section>
    ...
    <script>
        function confirmDelete() {
            ...
            const confirmation = confirm("Are you sure you want to delete this award?");
            if (confirmation) {

    ...
    <body>
        ...
        <section class="section" id="edit-team-member">
            <div class="container edit-container">
                ...
                <form action="team.php?action=edit" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="memberPosition" name="memberPosition" value="<?php echo htmlspecialchars($position); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="memberDescription" class="form-label">Description</label>
                        <textarea class="form-control" id="memberDescription" name="memberDescription" rows="5" required><?php echo htmlspecialchars($description); ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="memberPosition" class="form-label">Image</label>
                        <input type="text" class="form-control" id="memberImage" name="memberImage" value="<?php echo htmlspecialchars($image); ?>" required>
                    </div>
                    <div>
